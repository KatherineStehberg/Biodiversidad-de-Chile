    ...
    <><div className="bg-background-dark text-white min-h-screen flex items-center justify-center p-4">
      <div className="max-w-[520px] w-full flex flex-col items-center">
        ...
        <div className="w-full flex flex-col gap-3">
          <Link href="/dashboard" className="w-full text-white h-14 rounded-xl font-bold text-base transition-all transform active:scale-[0.98] shadow-lg flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700">
